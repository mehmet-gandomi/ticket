...
export const AddAnswer = ({ size, ...p }: IconProps) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.56006 18.75C9.15006 18.75 8.81006 18.41 8.81006 18V13C8.81006 12.59 9.15006 12.25 9.56006 12.25C9.97006 12.25 10.3101 12.59 10.3101 13V18C10.3101 18.41 9.97006 18.75 9.56006 18.75Z" fill="#FAFAFA"/>
    <path d="M12 16.25H7C6.59 16.25 6.25 15.91 6.25 15.5C6.25 15.09 6.59 14.75 7 14.75H12C12.41 14.75 12.75 15.09 12.75 15.5C12.75 15.91 12.41 16.25 12 16.25Z" fill="#FAFAFA"/>
