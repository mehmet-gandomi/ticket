...
export function ChatBubble({ msg }: { msg: ChatMessage }) {
  ...
  return (
    <div className={`flex flex-col gap-1 max-w-[60%] ${isUser ? 'self-end items-end' : 'self-start items-start'}`}>
      ...
      <div className={`flex items-center gap-2 text-[11px] text-ink-400 px-3 ${isUser ? '' : 'self-start flex-row-reverse'}`}>
